...
var NAIP2020 = ee.ImageCollection('USDA/NAIP/DOQQ')
  .filterBounds(ee.Geometry.Rectangle(-107.0, 35.38, -106.325, 34.9))
...
var samplePoints = ee.FeatureCollection("users/bassett/naip2020_canopysample_2022-02-16c").filterBounds(ee.Geometry.Rectangle(-107.0, 35.5, -106, 34.5));
...
var exportbounds = ee.Geometry.Rectangle([-107.0, 35.38, -106.325, 34.9]);

Export.image.toDrive({
  image: mode,
  description: 'ABQ_NAIP2020_CC_v01',
  region: exportbounds,
  fileFormat: 'GeoTIFF',
  crs: 'EPSG:26913',
  scale: 0.6,
